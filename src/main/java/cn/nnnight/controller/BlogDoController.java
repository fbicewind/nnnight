...
import cn.nnnight.service.blog.*;
...
public class BlogDoController {
    ...
    public ModelMap saveMusic(@RequestParam(value = "urlfile", required = false) MultipartFile urlfile,
                              ...
                              @RequestParam(value = "coverfile", required = false) MultipartFile coverfile, BlogMusic
                                      vo) {
        ModelMap map = new ModelMap();
        if (urlfile != null) {
    ...
    @ResponseBody
    public ModelMap saveEmotion(@RequestParam String text, @RequestParam String type) {
        ModelMap map = new ModelMap();
        boolean flag = blogEmotionService.saveEmotion(text, type);
        map.put("status", flag ? Constants.TRUE_FLAG : Constants.FALSE_FLAG);
        return map;
    }
    ...
    @ResponseBody
    public ModelMap updateGoal(@RequestParam String id, @RequestParam String type) {
        ModelMap map = new ModelMap();
        boolean flag = blogEmotionService.updateGoal(id, type);
        map.put("status", flag ? Constants.TRUE_FLAG : Constants.FALSE_FLAG);
        return map;
    }
