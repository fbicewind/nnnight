			...
			<c:choose>
				<c:when test="${SPRING_SECURITY_CONTEXT.authentication.principal.nickname == null && register != 1 }">
					<div style="float: right;margin-top: 15px;">
		             	<a style="cursor: pointer;margin-right:10px;" data-toggle="modal" data-target="#_loginModal">登陆</a>
				...
				<c:otherwise>
					<div style="float: right; margin-top: 5px">
						<a href="${path }/u/${SPRING_SECURITY_CONTEXT.authentication.principal.id }">
							<img class="user-avatar" src="/static/upload/img/s/${SPRING_SECURITY_CONTEXT.authentication.principal.avatar }">
						</a> 
