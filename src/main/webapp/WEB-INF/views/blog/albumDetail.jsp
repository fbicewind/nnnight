...
<body>
			...
			<div class="col-md-2 col-sm-3 col-xs-6 album-big-div">
				<div class="album-img-div">
					<a class="album-img-a" onclick="albumDetail.detail.showFullImage(${i.index })">
						<img class="album-photo photo-${i.index }" data-src="${blogPhoto.photo }" alt="" src="/static/upload/img/album/s/${blogPhoto.photo }">
					</a>
				</div>
			</div>
		</c:forEach>
	...
	<script src="${path }/static/js/notDragOut.js"></script>
	<script src="${path }/static/js/albumDetail.js"></script>
