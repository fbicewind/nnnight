...
<body>
				...
				<div class="panel-body nt-music-panel">
					<div>
						<div class="music-left-panel">
							...
							<div class="nt-music-favorable">
								<span class="music-love-button"><i class="fa fa-heart-o"
									aria-hidden="true"></i>&nbsp;喜欢</span> <span class="music-love-button"><i
									class="fa fa-star-o" aria-hidden="true"></i>&nbsp;收藏</span>
							</div>
						</div>
					...
					<div class="nt-music-operation">
						<div class="col-sm-3"
							...
							<i class="fa fa-step-backward fa-2x" aria-hidden="true"
								id="ntPrev"></i> <i
								class="fa fa-spinner fa-2x nt-loading-icon fast-spin"
								aria-hidden="true" id="loading"></i> <i
								class="fa fa-play-circle fa-2x nt-operation-icon"
								aria-hidden="true" id="play"></i> <i
								class="fa fa-pause-circle fa-2x nt-operation-icon"
								aria-hidden="true" style="display: none;" id="pause"></i> <i
								class="fa fa-step-forward fa-2x" aria-hidden="true" id="ntNext"></i>
						</div>
						<div class="col-sm-6 nt-music-center">
							...
							<div class="progress music-progress" id="musicProgress">
								<div class="progress-bar progress-bar-danger" role="progressbar"
									id="musicNowProgress" style="width: 0%;">
							...
							<div id="ntMusicList" class="nt-music-list">
								<h5 class="music-list-title">
									...
									<span style="float: right;">
										<i id="addMusic" title="添加音乐" class="fa fa-plus-square-o fa-lg" data-toggle="modal" data-target="#musicModal" style="margin-right: 20px;" aria-hidden="true"></i>
	...
	<div class="modal fade" id="musicModal" tabindex="-1" role="dialog" aria-labelledby="loginModalLabel" aria-hidden="true">
					...
					<form role="form" class="form-horizontal" id="musicForm" enctype="multipart/form-data" method="post">
							...
							<div id="musicFile">
								<div class="input-group col-sm-7" style="padding: 0 15px;">
									...
									<span class="input-group-btn">
										<button type="button" class="btn btn-default" onclick="$('#hiddenUrl').click()">选择文件</button>
									</span>
								</div>
						...
						<div class="form-group">
							...
							<div class="input-group col-sm-7" style="padding: 0 15px;">
								...
								<span class="input-group-btn">
									<button type="button" class="btn btn-default" onclick="$('#hiddenLrc').click()">选择文件</button>
								</span>
							</div>
						...
						<div class="form-group">
							...
							<div class="input-group col-sm-7" style="padding: 0 15px;">
								...
								<span class="input-group-btn">
									<button type="button" class="btn btn-default" onclick="$('#hiddenCover').click()">选择文件</button>
								</span>
							</div>
	...
	<script src="${path }/static/js/nightPlayer.js"></script>
	<script src="${path }/static/js/music.js"></script>
